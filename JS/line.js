...
// Deuxième liste indicateurs corrél^és
...
// Liste de tous les indicateurs utilisés (distincte)
...
function updateLineChart() {
  ...
  // Si aucun indicateur corrélé - désactiver ind2
  ...
  function updateChart() {
    ...
    // Filtrer les données sur l’intervalle commun
  ...
  // Trouver la valeur la plus proche ! (simlplifiée)
  ...
  function mousemove(event) {
    ...
    // Trouver valeurs correspondantes sur chaque courbe
